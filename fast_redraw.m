function varargout = fast_redraw(file_name, puzzle_size, origin_size, repeat, distance, overlap, puzzle_image)
...
% distance   : the distance between two same puzzles (-1 = unlimited)
...
result = redraw(small_origin, puzzle_list, repeat, distance, overlap);
imshow(result);
...
function result = redraw(origin, puzzle_list, repeat, distance, overlap)
